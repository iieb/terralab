...
COPY src /usr/src/terralab/
WORKDIR /usr/src/terralab
...
RUN chmod +x /usr/src/terralab/tasks.py \
    && chmod +x /usr/src/terralab/entrypoint.sh
...
# ENTRYPOINT /usr/src/terralab/entrypoint.sh
