...
#
PROJECT_NAME = "terralab"

# add trailing slash to site url. geoserver url will be relative to this
if not SITEURL.endswith("/"):
    SITEURL = "{}/".format(SITEURL)

SITENAME = os.getenv("SITENAME", "terralab")
...
EMAIL_HOST_USER = os.getenv("EMAIL_HOST_USER", "monitoramento@iieb.org.br") 
EMAIL_HOST_PASSWORD = os.getenv("EMAIL_HOST_PASSWORD") 
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "monitoramento@iieb.org.br")
